  ...
  return (
    <div>
      ...
      <section className="relative bg-[#DB620A1A] overflow-hidden">
        {/* GRID BACKGROUND */}
        <div className="absolute inset-0 opacity-30 bg-[linear-gradient(#e3c7b5_1px,transparent_1px),linear-gradient(90deg,#e3c7b5_1px,transparent_1px)] bg-[size:96px_67px]" />
        ...
        <div className="relative w-full px-4 sm:px-6 md:px-10 lg:px-[70px] py-12 md:py-16 lg:py-20 grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-6">
              <button className="bg-[#DB620A] flex justify-center group-hover:bg-[#ac4d09] items-center gap-2.5 border border-orange-500 text-white px-6 sm:px-10 lg:px-[60px] py-[10px] rounded-[8px] text-[14px] sm:text-[16px] lg:text-[18px] font-medium cursor-pointer">
                Register
                <img
                  src={rightWhite}
                  alt="arrow"
              ...
              <button className="flex justify-center items-center hover:bg-[#DB620A] hover:text-white gap-2.5 border border-orange-500 text-orange-500 px-6 sm:px-10 lg:px-[60px] py-[10px] rounded-[8px] text-[14px] sm:text-[16px] lg:text-[18px] font-medium cursor-pointer">
                Login
                <img
                  src={rightOrange}
                  alt="arrow"
        ...
        {/* DEMO STRIP */}
        <div className="relative w-full px-4 sm:px-6 md:px-10 lg:px-[70px] flex justify-center">
          <div className="w-[80%] bg-white shadow-[0px_1px_21.1px_0px_rgba(0,0,0,0.25)] rounded-xl px-4 sm:px-6 md:px-8 py-6 md:py-5 flex items-center justify-center gap-6 text-center translate-y-8">
            ...
            <button className="bg-[#1f3f68] text-white px-6 sm:px-6 py-4 text-sm sm:text-base md:text-lg lg:text-[20px] font-bold rounded-lg flex justify-center items-center gap-2.5">
