      ...
      >
        ...
        <div className="mb-8">
          <p className="text-lg font-extrabold text-gray-800 mb-1">
            Our executive will reach out to you at the earliest for resolution.
          </p>
          <p className="text-sm font-bold text-gray-500 leading-relaxed">
            Please note that callbacks for requests raised after 5:00 P.M. will
            be scheduled for next business day.
          </p>
        </div>
